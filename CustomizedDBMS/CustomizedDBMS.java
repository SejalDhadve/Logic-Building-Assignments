...
class Employee implements Serializable
{
    ...
    {
        System.out.println("Emp ID : "+this.EmpID+" Name : "+this.EmpName+" Age : "+this.EmpAge+" Emp Address : "+EmpAddress+" Emp Salary : "+EmpSalary);
    }

    public String toString()
    {
        return "ID : "+this.EmpID+" Name : "+this.EmpName+" Age : "+this.EmpAge+" Emp Address : "+EmpAddress+" Emp Salary : "+EmpSalary;
    }
}
