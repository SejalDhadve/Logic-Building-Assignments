...
class PACKER implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent aboj)
    {
        ...
        try
        {
            Packer pobj = new Packer(filename, foldername);
...
class UNPACKER implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent aboj)
    {
        ...
        try
        {
            Unpacker uobj = new Unpacker(filename);
...
//
//////////////////////////////////////////////////////////////////////////////////
class GUILauncher implements ActionListener
{
    ...
    //
    //////////////////////////////////////////////////////////////////////////////////////
    public GUILauncher(String title, int width, int height)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            new PACKER("Packer", 400, 300);
        }
        else if(e.getSource() == unpackerButton)
        {
            new UNPACKER("Unpacker", 400, 300);
        }
    ...
    public static void main(String A[])
    {
        ...
        while(true) 
        {
            ...
            else if(choice == 3)
            {
                ...
                new GUILauncher("GUI Mode", 400, 300);
            }
            else if(choice == 4) 
            {
                System.out.println("----------------------------------------------------------");
                System.out.println("Thank you for using PackerUnpacker Application.");
                System.out.println("----------------------------------------------------------");
                break;
            } 
            else 
