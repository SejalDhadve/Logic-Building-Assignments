...
class Tracker
{
    ...
    private ArrayList <StudyLog> Database = new ArrayList <StudyLog> ();      //Database = object
...
class StudyTracker               //StudyTrackerStarter
{
    public static void main(String A[])
    {
        Tracker stobj = new Tracker();
